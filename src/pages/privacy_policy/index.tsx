      ...
      <Container maxWidth="md" sx={{ py: 6 }}>
        ...
        <Box sx={{ mb: 4 }}>
          <Typography sx={{ mb: 2, lineHeight: 1.8, fontSize: "16px" }}>
            小川翔生（以下，「提供者」といいます。）は，iOS、Androidアプリで提供されるMeruboのサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
          </Typography>
        </Box>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography sx={{ lineHeight: 1.8, fontSize: "16px" }}>
            提供者は，ユーザーが利用登録をする際に氏名，生年月日，住所，電話番号，メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,提供者の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。
          </Typography>
        </Box>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          >
            ...
            <li>
              ・ユーザーが利用中のサービスの新機能，更新情報，キャンペーン等及び提供者が提供する他のサービスの案内のメールを送付するため
            </li>
            <li>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography sx={{ mb: 1, lineHeight: 1.8, fontSize: "16px" }}>
            1.
            提供者は，次に掲げる場合を除いて，あらかじめユーザーの同意を得ることなく，第三者に個人情報を提供することはありません。ただし，個人情報保護法その他の法令で認められる場合を除きます。
          </Typography>
          <Box
            component="ul"
          ...
          >
            ...
            <li>
              ・予め次の事項を告知あるいは公表し，かつ提供者が個人情報保護委員会に届出をしたとき
            </li>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography sx={{ lineHeight: 1.8, fontSize: "16px" }}>
            提供者は、提供を受けた個人情報をもとに、個人の特定できないよう加工した統計データを作成することがあります。個人を特定できない統計データについて、提供者は、法令に従ってこれを利用することができます。本サービスは、Cookie及び、これに類する技術(IDFA及びAAID等を含みます。)を利用することがあります。また、本サービスはこれらの技術と併せてGoogleアナリティクス及び、Firebaseを利用することがあります。これらの技術並びにGoogleアナリティクス及びFirebaseは、提供者による本サービスの利用状況等の把握に役立ち、サービス向上に資するものです。Googleアナリティクスでデータが収集、処理される仕組みについては、下記URLのGoogleアナリティクスのウェブサイトでご確認いただけます。www.google.com/policies/privacy/partners/
            Firebaseでデータが収集、処理される仕組みについては、下記URLのFirebaseのウェブサイトでご確認いただけます。https://firebase.google.com/support/privacy?hl=ja
          </Typography>
        </Box>
